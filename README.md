...
Furthermore, having 0 misplaced after this guess means that the player can also assume that "1" is in the secret code. If "1" was not in the secret code, the number of misplaced would have instead gone from 2 to 1 because the "2" was put in its correct position.
